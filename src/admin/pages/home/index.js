...
import { appSecret } from 'ADMIN_CONFIG/index';
import NavHeader from 'ADMIN_COMPONENT/NavHeader';
import NavSlider from 'ADMIN_COMPONENT/NavSlider';
import NavTab from 'ADMIN_COMPONENT/NavTab';
import Exception from 'ADMIN_COMPONENT/Exception';
import allRouters from 'ADMIN_ROUTER';
import { basename } from 'ADMIN_CONFIG/index';
import Loading from 'ADMIN_COMPONENT/loading';
import { setAuthInfo as setReqAuthInfo } from 'ADMIN_UTILS/request';
import navMenu from 'ADMIN_CONFIG/navMenu';
import styles from 'ADMIN_STYLES/page/home.less';

const { Content } = Layout;

const createRouteInfo = (allRouters, navMenu) => {
    const authPaths = navMenu.map((item) => (item.Path));
    const authRouters = [];
