 ...
 */
export const createFormField = (record: any, fieldPrefix: string = '') => (
    Object.keys(record).reduce((previousObj: any, currentKey: string) => {
 ...
 * @param {*} option 
 */
export const selectInputSearch = (input: string, option: any) => option.props.children.toLowerCase().indexOf(input.toLowerCase()) >= 0;
